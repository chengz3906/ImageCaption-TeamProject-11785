...
checkpoint = "BEST_checkpoint_flickr8k_max_cap_100_min_word_freq_3.pth.tar"  # path to checkpoint, None if none
...
def main():
    ...
    # Read word map
    word_map_file = "%s/%s_WORDMAP_min_word_freq_%d.json" % (data_folder, dataset_name, min_word_freq)
    ...
    for i, (imgs, caps, caplens) in enumerate(train_loader):
        ...
        if i % print_freq == 0:
            print('{0}\t'
                  ...
                  'Top-5 Accuracy {top5.val:.3f} ({top5.avg:.3f})'.format(datetime.now(),
